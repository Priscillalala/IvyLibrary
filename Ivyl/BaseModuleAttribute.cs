...
namespace IvyLibrary
{
    ...
    /// <item>Add this attribute to component classes (e.g., <see cref="Component"/>, <see cref="MonoBehaviour"/>, <see cref="ModularBehaviour{TModuleAttribute}"/>, or derived) in your codebase</item>
